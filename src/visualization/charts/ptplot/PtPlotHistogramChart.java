...
import collectives.util.Parameter;
import collectives.util.ParameterList;
...
public class PtPlotHistogramChart extends AbstractPtPlotChart {
	...
	private class PtPlotHistogramSequence extends AbstractPtPlotSequence {
		...
		protected void addPoint(DataItem item) {
			...
			histogram.addPoint(sequenceNumber,++itemNum,item.getDouble(attribute),true);
	...
	public PtPlotHistogramChart(String title, Map properties, boolean autoupdate, boolean autoclean,boolean autoresize) throws UnsoportedChartProperty {
		super(title,properties,autoupdate,autoclean,true);
	}

	public PtPlotHistogramChart(String title, Map properties, boolean autoupdate) throws UnsoportedChartProperty {
		this(title, properties, autoupdate,false,false);
	}
	...
	@Override
	protected PtPlotSequence createSequence(AbstractPtPlotChart plot, String name, DataSeries series, String attribute,int seqNum)
			throws UnsoportedChartProperty {
				
		return new PtPlotHistogramSequence(plot, histogram, name, series,attribute,seqNum);
