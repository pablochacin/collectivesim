package collectivesim.launcher;

import java.security.InvalidParameterException;
import java.util.HashMap;
import java.util.Map;

import collectivesim.configuration.PropertiesConfiguration;
...
public class ExperimentLauncher implements Runnable {
	 ...
	 */
	public ExperimentLauncher(Map<String, String> argsMap) {
		this.argsMap = new HashMap<String, String>(argsMap);
	}

	/**
	 * Constructor without parameters. Requires  the method <code>initialize</code> 
