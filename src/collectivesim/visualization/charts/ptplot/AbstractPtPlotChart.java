...
public abstract class AbstractPtPlotChart implements Chart {
	...
	private static Map<String,String> EMPTY_PROPERTIES_MAP = new HashMap<String,String>(); 
	 ...
	 */
	protected AbstractPtPlotChart(String name,String title,Map<String, String> properties,boolean autoupdate, boolean autoclean,boolean autoResize) throws UnsoportedChartProperty {
	...
	public AbstractPtPlotChart() throws UnsoportedChartProperty {
		this("","",new HashMap<String,String>(),false,false,true);
	}
	...
	public AbstractPtPlotChart(boolean autoupdate) throws UnsoportedChartProperty{
		this("","",new HashMap<String,String>(),autoupdate,false,true);
	}
	...
	public void addSequence(String name,DataSeries series,String sequenceAttribute,String valueAttribute) throws UnsoportedChartProperty  {
		addSequence(name,series, sequenceAttribute,valueAttribute,new HashMap<String,String>());
	}

	public void setProperties(Map<String,String> properties) throws UnsoportedChartProperty {

		Parameter<Integer> height = new Parameter<Integer>(CHART_HEIGHT);
		
		Parameter<Integer> width = new Parameter<Integer>(CHART_WIDTH);
